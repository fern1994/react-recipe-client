import gql from 'graphql-tag' // gql ใช้คลุม string ที่ query

import { recipeFragment} from './fragments'

/** Recipe Query */

// เป็นคล้ายคำสั่ง query โดยให้ตัวแปรนี้เท่ากับ query  getAllRecipes
